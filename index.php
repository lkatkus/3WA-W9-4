  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="row mb-2">
          ...
          <?php
              $review = new Review();
              $allReviews = $review -> getFeaturedReviews();
              foreach ($allReviews as $review): ?>

              <div class="col-md-6">
                  <div class="card flex-md-row mb-4 box-shadow h-md-250">
                      <div class="card-body d-flex flex-column align-items-start">
                          <strong class="d-inline-block mb-2 text-primary"><?= $review['first_name']; ?></strong>
                          <h3 class="mb-0">
                              <a class="text-dark" href="#"><?= substr($review['content'],0,10)?></a>
                          </h3>
                          <div class="mb-1 text-muted"><?php $date = new DateTime($review['timestamp']); echo $date->format('M d'); ?></div>
                          <p class="card-text mb-auto"><?= substr($review['content'],0,100).' ...'?></p>
                      </div>
    ...
    <main role="main" class="container">
      <div class="row">
        <div class="col-md-8 blog-main">
          <h3 class="pb-3 mb-4 font-italic border-bottom">Guestbook reviews</h3>
            ...
            <?php
                ...
                <div class="blog-post">
                    <h2 class="blog-post-title"><?= substr($review['content'],0,10)?></h2>
                    <p class="blog-post-meta"><?php $date = new DateTime($review['timestamp']); echo $date->format('M d, Y').' by '; ?><a href="#"><?= $review['first_name']; ?></a></p>
                    <p><?= $review['content']; ?></p>
                    <hr>
                </div><!-- /.blog-post -->
